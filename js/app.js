...
(function () {
  ...
  const MOUNTAINS = [
    ...
    { name: "玳瑁山", pts: [[25.55, 116.75], [25.4, 116.9], [25.25, 117.05], [25.1, 117.15]], labelAt: [25.38, 116.95] },
  ];
  const RIVER_T1 = new Set(["闽江", "九龙江", "晋江", "汀江", "木兰溪", "交溪", "霍童溪", "敖江", "龙江", "漳江", "东溪"]);
  ...
  function initMap() {
    ...
    map.fitBounds(fujianBounds.pad(mobileView ? 0.9 : 0.16), { animate: false });
